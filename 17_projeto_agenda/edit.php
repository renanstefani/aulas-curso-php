...
?>
    <div class="container">
        ...
        <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
            <!-- inputs abaixo usados para controlar envio do form -->
            ...
            <div class="form-group">
                ...
                <textarea type="text" rows="5" class="form-control" id="observations" name="observations"><?= $contact['observations'] ?></textarea>
            </div>
